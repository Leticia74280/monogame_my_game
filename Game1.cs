...
namespace Breakout_Game
{
    ...
    public class Game1 : Game
    {
        ...
        {          
            ...
            {
                new Rectangle(0,0,128,128), new Rectangle(128,0,128,128), new Rectangle(256,0,128,128), new Rectangle(384,0,128,128)
            };
            index = 0;
            time = 0.0;
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(coinTexture, new Rectangle(0,0, 128, 128), frames[index], Color.White);
